...
describe("Test whitelistBatch function", async function () {
    ...
    it("should try and whitelist users with another account (not owner)", async () => {
        ...
        await interactionNFTAdd1.whitelistBatch(addresses).then(res => {
    ...
    it("should transferOwnership and whitelist after that", async () => {
        ...
        await nft.whitelistBatch(addresses).then(res => {
            console.log("must throw err")
        }).catch(err => {
